namespace SQLLiteSample.ViewModel
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        {
            _navigationService.NavigateTo(new Uri("/CreateUniversityPage.xaml", UriKind.Relative));
        }
        ...
        private async Task DeleteUniversity()
        {
            ...
            {
                _messageBoxService.Show("Select one university.");
            }
        }
        ...
        /// </summary>
        private void UpdateUniverity()
        {
            if (SelectedUniversity != null)
            {
               _navigationService.NavigateTo(new Uri(string.Format("/EditUniversityPage.xaml?university={0}", SelectedUniversity.Id.ToString()), UriKind.Relative));
            }
            else
            {
                _messageBoxService.Show("Select one university.");
        ...
        private void SeeStudents()
        {
            if (SelectedUniversity != null)
            {
                _navigationService.NavigateTo(new Uri(string.Format("/SeeStudentsPage.xaml?university={0}", SelectedUniversity.Id.ToString()), UriKind.Relative));
            }
            else
            {
                _messageBoxService.Show("Select one university.");
